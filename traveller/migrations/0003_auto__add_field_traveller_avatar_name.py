...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Traveller.avatar_name'
        db.add_column(u'traveller_traveller', 'avatar_name',
    ...
    def backwards(self, orm):
        # Deleting field 'Traveller.avatar_name'
        db.delete_column(u'traveller_traveller', 'avatar_name')
