...
def friend_management(request):
    return render(request, "friendship/friend_management.html")

def friendship_all_friends(request):
    all_friends = Friend.objects.friends(request.user)

    return render(request, "friendship/all_friends.html", {'all_friends':all_friends})
