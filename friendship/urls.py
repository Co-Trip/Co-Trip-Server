...
from friendship.views import view_friends, friendship_add_friend, friendship_accept, \
        ...
        friendship_request_list_rejected, friendship_requests_detail, all_users, friend_management, friendship_all_friends
...
urlpatterns = patterns('',
    ...
    url(
        regex=r'^all_friends/$',
        view=friendship_all_friends,
        name='friendship_all_friends',
    ),
    # url(
